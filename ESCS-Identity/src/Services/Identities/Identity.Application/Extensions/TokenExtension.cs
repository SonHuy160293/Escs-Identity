...
namespace Identity.Application.Extensions
{
    public static class TokenExtension
    {
        ...
        public static string CreateAccessToken(User user, List<string>? userRoles, long? serviceId, bool isExpired)
        {
            ...
            // Determine expiration time based on the isExpired parameter
            DateTime? expiration = isExpired ? DateTime.Now.AddHours(1) : (DateTime?)null;
            ...
            var claims = new List<Claim>()
         {
             ...
             new Claim("ServiceId", serviceId.ToString() ?? string.Empty)
